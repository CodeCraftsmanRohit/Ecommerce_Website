...
const Profile = () => {
      ...
      <div className="h-40 w-full bg-gradient-to-r from-green-400 to-blue-400 rounded-xl overflow-hidden relative shadow-md">
       ...
       <div className="absolute inset-0 bg-black/30 flex items-center justify-center px-6 py-4">
          <h1 className="text-3xl md:text-4xl font-extrabold text-white text-center drop-shadow-lg tracking-wide">
            👋 Welcome, <span className="underline decoration-wavy decoration-green-300">{name}</span>!
          </h1>
        </div>
      </div>
  ...
  <h2 className="text-lg font-semibold text-green-600 uppercase tracking-wide">Personal Details</h2>
  ...
  {/* Optional future personal details here */}
</div>
      </div>

     {/* Eco Stats */}
<div className="mt-10">
  <h2 className="text-lg font-semibold text-green-600 uppercase tracking-wide mb-4">Eco Scorecard</h2>
  <CarbonTracker />
</div>
    </div>
  );
